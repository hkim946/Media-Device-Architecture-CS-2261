...
void goToStart() {
    ...
    state = START;
    drawChar(105, 80, 'S', ((31) | (31)<<5 | (31)<<10));
    drawChar(111, 80, 'T', ((31) | (31)<<5 | (31)<<10));
    drawChar(117, 80, 'A', ((31) | (31)<<5 | (31)<<10));
    drawChar(123, 80, 'R', ((31) | (31)<<5 | (31)<<10));
    drawChar(129, 80, 'T', ((31) | (31)<<5 | (31)<<10));
}
...
void goToPause() {
    ...
    state = PAUSE;
    drawChar(105, 80, 'P', ((31) | (31)<<5 | (31)<<10));
    drawChar(111, 80, 'A', ((31) | (31)<<5 | (31)<<10));
    drawChar(117, 80, 'U', ((31) | (31)<<5 | (31)<<10));
    drawChar(123, 80, 'S', ((31) | (31)<<5 | (31)<<10));
    drawChar(129, 80, 'E', ((31) | (31)<<5 | (31)<<10));
}
...
void goToWin() {
    fillScreen(((7) | (23) << 5 | (4) << 10));
    state = WIN;
    drawChar(110, 80, 'W', ((31) | (31)<<5 | (31)<<10));
    drawChar(116, 80, 'I', ((31) | (31)<<5 | (31)<<10));
    drawChar(122, 80, 'N', ((31) | (31)<<5 | (31)<<10));
...
void goToLose() {
    ...
    state = LOSE;
    drawChar(107, 80, 'L', ((31) | (31)<<5 | (31)<<10));
    drawChar(113, 80, 'O', ((31) | (31)<<5 | (31)<<10));
    drawChar(119, 80, 'S', ((31) | (31)<<5 | (31)<<10));
    drawChar(125, 80, 'E', ((31) | (31)<<5 | (31)<<10));
}
