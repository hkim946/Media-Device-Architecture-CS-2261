...
void drawLand() {
 drawRect(0, 0, 240, 15, ((0) | (10) << 5 | (4) << 10));
}
...
void updateFrog() {
 ...
 if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))
  ...
  && frog.col + frog.width - 1 < 240 - frog.cdel) {

  frog.col += frog.cdel;
 } else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<6))) ) {
        frog.row -= frog.rdel;
    } else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<7))) && frog.row + frog.height - 1 < 160 - frog.rdel) {
        frog.row += frog.rdel;
    }
...
void drawFrog() {
 ...
 drawRect(frog.oldCol, frog.oldRow, frog.width, frog.height, ((0) | (19) << 5 | (29) << 10));
...
void drawLogs(LOG* l) {
 drawRect(l -> oldCol, l -> oldRow, l -> width, l -> height, ((0) | (19) << 5 | (29) << 10));
