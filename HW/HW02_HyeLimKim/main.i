 ...
 if (rRow + rHeight > 160) {
  ...
  rRow = (160 - 1) - (rHeight - 1);
    ...
    if (collision(bCol, bRow, bWidth, bHeight, lCol, lRow, lWidth, lHeight)) {
        ...
        if (rColor == ((31) | (31)<<5 | (0)<<10)) {
            rColor = ((0) | (31)<<5 | (0)<<10);
        } else if (rColor == ((0) | (31)<<5 | (0)<<10)) {
            rColor = ((31) | (31)<<5 | (0)<<10);
        }
        rScore++;
    }
    ...
    if(collision(bCol, bRow, bWidth, bHeight, rCol, rRow, rWidth, rHeight)) {
        ...
        if (lColor == ((0) | (31)<<5 | (31)<<10)) {
            lColor = ((31) | (0)<<5 | (31)<<10);
        } else if (lColor == ((31) | (0)<<5 | (31)<<10)) {
            lColor = ((0) | (31)<<5 | (31)<<10);
        }
        lScore++;
    }
